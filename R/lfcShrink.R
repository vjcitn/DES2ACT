...
#' Specifying \code{apeglm} passes along DES2ACT MLE log2
...
#' Specifying \code{ashr} passes along DES2ACT MLE log2
...
#' \code{"normal"} is the 2014 DES2ACT shrinkage estimator using a Normal prior;
...
#' dispersion for RNA-seq data with DES2ACT. Genome Biology, 15:550.
...
See ?lfcShrink for more details on shrinkage type, and the DES2ACT vignette.
Reference: https://doi.org/10.1093/bioinformatics/bty895")
  ...
  pkg <- if (type == "normal") "DES2ACT" else type
